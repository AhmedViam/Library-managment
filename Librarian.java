...
public class Librarian extends javax.swing.JFrame {
 ...
 @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        new_pass = new javax.swing.JButton();
        ...
        jLabel3.setText("  Librarian Panel");
        ...
        new_pass.setForeground(new java.awt.Color(255, 51, 51));
        new_pass.setText("request new password");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(check, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
 ...
 private void reportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_reportActionPerformed
   ...
   Statement stmt = null;
    ...
    String sql;
     sql = ("update `user`set AccountFlag = \"newlib\" where AccountName like (SELECT AccountName FROM login ORDER BY ID DESC LIMIT 1)");
     JOptionPane.showMessageDialog(null, "New password request succesfull, you will be prompted to a new password on the next login");
 ...
 public static void main(String args[]) {
  ...
  /* Create and display the form */
    ...
    private javax.swing.JButton new_pass;
